...
class FoveateScene : public QGraphicsScene
{
    ...
    void setImage (const QImage &image)
    {
        ...
        switch (source.format ())
        {
            ...
            {
                raster<unsigned char> m1 (H, W);
                raster<unsigned char> m2 (H, W);
                raster<unsigned char> m3 (H, W);
    ...
    void encode ()
    {
        ...
        try
        {
            ...
            switch (dest.format ())
            {
                ...
                case QImage::Format_RGB32:
                {
                    const raster<unsigned char> *m1;
                    const raster<unsigned char> *m2;
                    const raster<unsigned char> *m3;
    ...
    bitmap_blending_map<raster<unsigned char>, float> bitmap_blending_map_object;
