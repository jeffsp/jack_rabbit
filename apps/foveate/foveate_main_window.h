...
class MainWindow : public QMainWindow
{
        ...
        , blending_map_filename ("")
    {
        ...
        if (!blending_map_filename.isEmpty ())
        {
            ...
            else
            {
                ...
                if (scene.getFoveationMode () == jack_rabbit::FoveateScene::FoveationModeBitmap)
                {
                    scene.setFoveationMode (jack_rabbit::FoveateScene::FoveationModeFunction);
    ...
    void on_action_Export_Blending_Map_triggered ()
    {
        ...
        im.setColorTable (t);
        jack_rabbit::e2_blending_map<> map;
        ...
        for (int y = 0; y < im.height (); ++y)
        {
            ...
            for (int x = 0; x < im.width (); ++x)
            {
                ...
                float res = map.get_blending_level (xoff, yoff)
                    * jack_rabbit::FoveateScene::BITMAP_BLENDING_MAP_DIVISOR;
                if (res < 0)
                    res = 0;
                else if (res > 255)
                    res = 255;
    ...
    {
        scene.setFixationMode (jack_rabbit::FoveateScene::FixationModeContinuous);
        setCursor ();
    }
    void on_action_Fixation_Mode_Single_triggered ()
    {
        scene.setFixationMode (jack_rabbit::FoveateScene::FixationModeSingle);
        setCursor ();
    }
    ...
    {
        scene.setFoveationMode (jack_rabbit::FoveateScene::FoveationModeBitmap);
    }
    void on_action_Foveation_Mode_Off_triggered ()
    {
        scene.setFoveationMode (jack_rabbit::FoveateScene::FoveationModeOff);
    }
    ...
    {
        scene.setWheelMode (jack_rabbit::FoveateScene::WheelModeE2);
    }
    void on_action_Wheel_Mode_Off_triggered ()
    {
        scene.setWheelMode (jack_rabbit::FoveateScene::WheelModeOff);
    }
    ...
    void setCursor ()
    {
        ...
        {
            case jack_rabbit::FoveateScene::FixationModeContinuous:
            ui.graphicsView->viewport()->setProperty("cursor", QVariant(QCursor(Qt::CrossCursor)));
            break;
            case jack_rabbit::FoveateScene::FixationModeSingle:
    ...
    void readSettings()
    {
        ...
        switch (fixation_mode)
        {
            ...
            fixation_mode = jack_rabbit::FoveateScene::FixationModeContinuous;
            // Fall through
            case jack_rabbit::FoveateScene::FixationModeContinuous:
        ...
        switch (foveation_mode)
        {
            ...
            foveation_mode = jack_rabbit::FoveateScene::FoveationModeFunction;
            // Fall through
            case jack_rabbit::FoveateScene::FoveationModeFunction:
            ui.action_Foveation_Mode_Function->setChecked (true);
            break;
            case jack_rabbit::FoveateScene::FoveationModeBitmap:
            ui.action_Foveation_Mode_Bitmap->setChecked (true);
            break;
            case jack_rabbit::FoveateScene::FoveationModeOff:
        ...
        switch (wheel_mode)
        {
            ...
            wheel_mode = jack_rabbit::FoveateScene::WheelModeE2;
            // Fall through
            case jack_rabbit::FoveateScene::WheelModeE2:
            ui.action_Wheel_Mode_Falloff->setChecked (true);
            break;
            case jack_rabbit::FoveateScene::WheelModeOff:
    ...
    QDialog export_dlg;
    jack_rabbit::FoveateScene scene;
    QSettings settings;
